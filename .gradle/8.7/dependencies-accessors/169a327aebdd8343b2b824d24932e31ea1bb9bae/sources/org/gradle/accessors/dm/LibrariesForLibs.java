...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ApacheCommonsLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>apacheCommonsNet</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getNet() {
            return create("apache.commons.net");
        }
    ...
    public static class GoogleApiServicesLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>gmail</b> with <b>com.google.apis:google-api-services-gmail</b> coordinates and
         * with version reference <b>gmailApi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGmail() {
            return create("google.api.services.gmail");
        }
    ...
    public static class IoCoilLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>io.coil.kt</b>
         */
        public IoCoilKtLibraryAccessors getKt() {
            return laccForIoCoilKtLibraryAccessors;
        }
    ...
    public static class IoCoilKtLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("io.coil.kt.compose");
        }

    }

    public static class JavaLibraryAccessors extends SubDependencyFactory {
        private final JavaMailLibraryAccessors laccForJavaMailLibraryAccessors = new JavaMailLibraryAccessors(owner);

        public JavaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>java.mail</b>
         */
        public JavaMailLibraryAccessors getMail() {
            return laccForJavaMailLibraryAccessors;
        }

    }

    public static class JavaMailLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public JavaMailLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>mail</b> with <b>com.sun.mail:android-mail</b> coordinates and
         * with version reference <b>javaMail</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("java.mail");
        }

        /**
         * Dependency provider for <b>activation</b> with <b>com.sun.activation:javax.activation</b> coordinates and
         * with version <b>1.2.0</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getActivation() {
            return create("java.mail.activation");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>apacheCommonsNet</b> with value <b>3.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getApacheCommonsNet() { return getVersion("apacheCommonsNet"); }
        ...
        /**
         * Version alias <b>gmailApi</b> with value <b>v1-rev20240520-2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGmailApi() { return getVersion("gmailApi"); }
        ...
        /**
         * Version alias <b>javaMail</b> with value <b>1.6.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJavaMail() { return getVersion("javaMail"); }
